...
const NavBar = () => {
  const [isWidthBiggerThan750Visible, setIsWidthBiggerThan750Visible] =
    useState(false);

  const handleLinkClick = () => {
    setIsWidthBiggerThan750Visible(!isWidthBiggerThan750Visible);
  };
  ...
  return (
    <nav className="navbar">
      <ul className="navbarList">
        <a
          href="javascript:;"
          className="widthSmallerThan750"
          onClick={handleLinkClick}
        ></a>
        <div
          className={
            isWidthBiggerThan750Visible
              ? "widthBiggerThan750Display"
              : "widthBiggerThan750NotDisplay"
          }
        >
